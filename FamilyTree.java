...
public class FamilyTree
{
    ...
    private static class TreeNode
    {
        ...
        TreeNode getNodeWithName(String targetName)
        {
            ...
            for (TreeNode child: children)
            {
            	...
            	TreeNode valNode = child.getNodeWithName(targetName);
            	if(valNode != null) {
            		return valNode;
            	}
            }
	...
	private void addLine(String line) throws TreeException
	{
		...
		if(parentNode == null) {
			throw new TreeException("Parent node is null");
			}
		}
	...
	TreeNode getMostRecentCommonAncestor(String name1, String name2) throws TreeException
	{
		...
		if (node1 == null)
			throw new TreeException("node 1 should not be null");
		TreeNode node2 = root.getNodeWithName(name2);
		if (node2 == null)
			throw new TreeException("node 2 should not be null");
